...
EXPECTED_OPS = {
    ...
    "qwen3_14b": [
        ...
        "forward.attention.o_proj.base_frozen_asymgemm",
        "forward.mlp.gate_proj.base_frozen_asymgemm",
        "forward.mlp.up_proj.base_frozen_asymgemm",
        "forward.mlp.down_proj.base_frozen_asymgemm",
        "backward.mlp.down_proj.base_dx_asymgemm",
        "backward.mlp.up_proj.base_dx_asymgemm",
        "backward.mlp.gate_proj.base_dx_asymgemm",
        "backward.attention.o_proj.base_dx_asymgemm",
        "backward.attention.v_proj.base_dx_asymgemm",
