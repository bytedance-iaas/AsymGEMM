...
LF_DIR=${LF_DIR:-${ASYMGEMM_DIR}/third-party/LlamaFactory}
KT_DIR=${KT_DIR:-${ASYMGEMM_DIR}/third-party/ktransformers}
DEEPSPEED_DIR=${DEEPSPEED_DIR:-${ASYMGEMM_DIR}/third-party/deepspeed}
LIGER_DIR=${LIGER_DIR:-${ASYMGEMM_DIR}/third-party/Liger-Kernel}
