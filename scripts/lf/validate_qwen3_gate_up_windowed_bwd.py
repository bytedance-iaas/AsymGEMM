...
def main() -> None:
    ...
    parser.add_argument("--stage", default="stage4_native_direct_e2e")
    parser.add_argument("--op", default="native_e2e")
    parser.add_argument("--case", default="tiny")
    parser.add_argument("--device", default="cuda:0")
    parser.add_argument("--profile-mode", choices=["none", "cuda-events", "nsys", "ncu"], default="none")
    parser.add_argument("--mode", default="cache_first_window")
    parser.add_argument("--p", type=int)
    parser.add_argument("--q", type=int)
    parser.add_argument("--bm", type=int)
    parser.add_argument("--bk", type=int)
    parser.add_argument("--g-work", type=int)
    parser.add_argument("--lora-scale", type=float, default=0.5)
    parser.add_argument("--lora-dropout", type=float, default=0.0)
    parser.add_argument("--expert-policy", default="tok-le1024")
    parser.add_argument("--with-down-lora-a", action="store_true", help="Validate selected dA_down output from the native op")
    parser.add_argument("--r-down", type=int, default=8)
    parser.add_argument("--down-dropout-p", type=float, default=0.0)
    parser.add_argument("--seed", type=int, default=0)
    parser.add_argument("--warmup-iters", type=int, default=1)
    parser.add_argument("--latency-iters", type=int, default=1)
    parser.add_argument("--max-abs-tol", type=float, default=5.0)
    parser.add_argument("--max-rel-tol", type=float, default=2.0e-2)
    parser.add_argument("--output-dir", default="profiling/qwen3_gate_up_windowed_bwd/manual")
