...
CONFIGS=(
  ...
  # "158000 : 8 : q3-30b-a3b|1 ; asym_cpuadamwds|recomp-off-full-fg-ker101-ceil0000-ohbm{ohbm}|ligerloss1 ; {seq}|8|1 ; none|false|false|false|false|false" # 986s, C-889, G-183, C-OOM 166k [DONE]
  # "54000 : 4 : q3-32b|1 ; asym_cpuadamwds|recomp-off-full-fg-ker000-ceil0000-ohbm{ohbm}|ligerloss1 ; {seq}|8|1 ; none|false|false|false|false|false" # 721s, C-894, G-183, C-OOM 58k [DONE]
  ...
  # "53000 : 4 : q3-32b|1 ; superoffload_mem|unsloth-off-ohbm{ohbm}|ligerloss1 ; {seq}|8|1 ; none|false|false|false|false|false" # 444s, C-845, G-181, C-OOM 54k [DONE]
