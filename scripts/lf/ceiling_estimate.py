...
Usage:
  python3 scripts/lf/ceiling_estimate.py <config-list>          # print table + write scripts/lf/ceiling_table.md
  python3 scripts/lf/ceiling_estimate.py <config-list> -v       # + fit diagnostics
  python3 scripts/lf/ceiling_estimate.py <config-list> --md PATH   # write the markdown elsewhere
  python3 scripts/lf/ceiling_estimate.py <config-list> --no-md     # stdout only
  python3 scripts/lf/ceiling_estimate.py <config-list> --state-dir PATH  # read results from a
...
def main():
    ...
    if md_path:
        lines = [
            "# Ceiling Table",
            "",
            f"Generated by `scripts/lf/ceiling_estimate.py {args[0]}` on "
