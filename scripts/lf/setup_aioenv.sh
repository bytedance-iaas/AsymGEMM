...
# Scratch area for downloaded/extracted .debs (local NVMe by default; falls back to /tmp).
WORK_BASE=${AIO_WORK_DIR:-/scratch_local/user_data/shutian/kevin/cache/deps/libaio}
