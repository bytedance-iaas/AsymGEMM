...
if [[ "${_RUNS_ENV_SET}" == "true" ]]; then
  ...
  RUNS=(
    ...
    # "q3.5-35b-a3b|1 ; superoffload_mem|unsloth-off|ligerloss1 ; 80000|8|1 ; none|false|false|false|false|false" # 80k OK (max tested); ceiling >80k, NOT probed above (likely ~130k by analogy to q3-30b-a3b)
    ...
    # "q3.5-35b-a3b|1 ; superoffload_mem|recomp|ligerloss1 ; 45000|8|1 ; none|false|false|false|false|false" # UNTESTED - no ceiling data anywhere (seq is an est. by analogy to q3-30b-a3b recomp 46k; needs a probe)
  )
  # RUNS=(
  #   # "q3-30b-a3b|1 ; superoffload_mem|unsloth|ligerloss1 ; 80000|8|1 ; none|false|false|false|false|false" # G-OOM 81k
