#!/bin/bash
# v2m_mixtral.sh — V2 mixtral dev entry, rerun of the v1f mixtral 6-pack after
# repointing mixtral-8x22b at the hub cache (the fused copy lives only on the
# other campaign machine). T1 floor trio (spl tiny rings) + T2 armed-probe trio
...
echo "V2M begin $(date +%m-%d_%H:%M)" >> "$S"
