...
echo "V2M3 begin $(date +%m-%d_%H:%M)" >> "$S"
cell m_splt2 mixtral-8x22b "$SPL" T2 64000 1 ASYM_ARENA_SHM_CAP_GB=460 ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=131072 ASYM_EP_SEP_NO_SNAP=1 ASYM_EP_SEP_MAX_MPE=999999
cell m_sp2t2 mixtral-8x22b "$SP2" T2 64000 1 ASYM_ARENA_SHM_CAP_GB=460
cell m_sdpt2 mixtral-8x22b "$SDP" T2 64000 1 ASYM_ARENA_SHM_CAP_GB=460
guard || true
echo "V2M3-DONE $(date +%m-%d_%H:%M)" >> "$S"
