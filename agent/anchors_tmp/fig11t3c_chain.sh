...
echo "FIG11T3C begin $(date +%m-%d_%H:%M)" >> "$S"
...
cell_raw ft3o8_320 glm4.7-flash 320000 512 recomp-off-full-fg-ker101-ohbm8
cell_raw ft3o8_640 glm4.7-flash 640000 512 recomp-off-full-fg-ker101-ohbm8
cell_t3 qt3_1100 q3-30b-a3b 1100000 512
guard || true
echo "FIG11T3C-DONE $(date +%m-%d_%H:%M)" >> "$S"
