...
echo "V3H4 begin $(date +%m-%d_%H:%M)" >> "$S"
...
cell h_spl64 hunyuan-a13b "$SPL" T2B 64000 2 ASYM_ARENA_SHM_CAP_GB=320 ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=65536
cell h_sp264 hunyuan-a13b "$SP2" T2B 64000 2 ASYM_ARENA_SHM_CAP_GB=320
cell h_sdp64 hunyuan-a13b "$SDP" T2B 64000 2 ASYM_ARENA_SHM_CAP_GB=320
# ---- forced-arm correctness probe (armed>0 requirement of §5) ----
cell h_splt2b hunyuan-a13b "$SPL" T2B 64000 2 ASYM_ARENA_SHM_CAP_GB=320 ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=262144 ASYM_EP_SEP_NO_SNAP=1 ASYM_EP_SEP_MAX_MPE=999999
# ---- ceiling 320k b1 T2B trio (spl minimal rings) ----
cell h_spl320 hunyuan-a13b "$SPL" T2B 320000 1 ASYM_ARENA_SHM_CAP_GB=320 ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=512
cell h_sp2320 hunyuan-a13b "$SP2" T2B 320000 1 ASYM_ARENA_SHM_CAP_GB=320
cell h_sdp320 hunyuan-a13b "$SDP" T2B 320000 1 ASYM_ARENA_SHM_CAP_GB=320
guard || true
echo "V3H4-DONE $(date +%m-%d_%H:%M)" >> "$S"
