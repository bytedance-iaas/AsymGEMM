...
echo "V4Q2 begin $(date +%m-%d_%H:%M)" >> "$S"
...
rm -rf profiling_results/profiling/asym_long_sft_smoke__lora__lf__bf16/q35_spl896__*
cell q35_spl896 q3.5-35b-a3b "$SPL" T2 896000 1 ASYM_EP_SEP_SLOT_ROWS=65536
rm -rf profiling_results/profiling/asym_long_sft_smoke__lora__lf__bf16/q122_spl336__*
cell q122_spl336 q3.5-122b-a10b "$SPL" T1 336000 1 ASYM_ARENA_SHM_CAP_GB=400 ASYM_EP_SEP_SLOT_ROWS=512
guard || true
echo "V4Q2-DONE $(date +%m-%d_%H:%M)" >> "$S"
