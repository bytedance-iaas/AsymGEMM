...
echo "V4Q5 begin $(date +%m-%d_%H:%M)" >> "$S"
...
cell q122_spl288 q3.5-122b-a10b "$SPL" T1 288000 1 ASYM_ARENA_SHM_CAP_GB=400 ASYM_EP_SEP_SLOT_ROWS=512
cell q122_sp2288 q3.5-122b-a10b "$SP2" T1 288000 1 ASYM_ARENA_SHM_CAP_GB=400
cell q122_sdp288 q3.5-122b-a10b "$SDP" T1 288000 1 ASYM_ARENA_SHM_CAP_GB=400
guard || true
echo "V4Q5-DONE $(date +%m-%d_%H:%M)" >> "$S"
