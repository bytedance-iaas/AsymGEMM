...
#   usage: fig13_bench_driver128.sh <gpupair 0,1|2,3> <tag> <model...>
...
mtot_of()  { case "$1" in qwen3-30b) echo 2048000;; qwen3.5-122b) echo 2048000;; glm4.7-flash) echo 1024000;; esac; }
...
EOF
  ...
  for SET in math code science; do
    for VAR in placed oracle contig; do
      OUT=$H/walls128_${MODEL}_${SET}_${VAR}.json
