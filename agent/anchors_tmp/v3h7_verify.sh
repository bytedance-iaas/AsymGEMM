...
echo "V3H7 begin $(date +%m-%d_%H:%M)" >> "$S"
rm -rf profiling_results/profiling/asym_long_sft_smoke__lora__lf__bf16/h_sp264__* profiling_results/profiling/asym_long_sft_smoke__lora__lf__bf16/h_splt2b__*
...
cell h_spl64r hunyuan-a13b "$SPL" T2B 64000 2 ASYM_ARENA_SHM_CAP_GB=320 TRUST_REMOTE_CODE=false ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=8192
cell h_spl320r hunyuan-a13b "$SPL" T2B 320000 1 ASYM_ARENA_SHM_CAP_GB=320 TRUST_REMOTE_CODE=false ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=512
cell h_sp2320r hunyuan-a13b "$SP2" T2B 320000 1 ASYM_ARENA_SHM_CAP_GB=320 TRUST_REMOTE_CODE=false
guard || true
echo "V3H7-DONE $(date +%m-%d_%H:%M)" >> "$S"
