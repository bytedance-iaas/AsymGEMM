...
echo "V2M10 begin $(date +%m-%d_%H:%M)" >> "$S"
cell m_spl288r2 mixtral-8x22b "$SPL" T1 288000 1 ASYM_ARENA_SHM_CAP_GB=285 ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=512
cell m_spl288h mixtral-8x22b "$SPL" T1 288000 1 ASYM_ARENA_SHM_CAP_GB=285 ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=512 ASYM_EP_SEP_TRANSPORT=host

guard || true
echo "V2M10-DONE $(date +%m-%d_%H:%M)" >> "$S"
