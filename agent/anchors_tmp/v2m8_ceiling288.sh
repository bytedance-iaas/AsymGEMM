...
echo "V2M8 begin $(date +%m-%d_%H:%M)" >> "$S"
cell m_spl288 mixtral-8x22b "$SPL" T1 288000 1 ASYM_ARENA_SHM_CAP_GB=285 ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=512
cell m_sp2288 mixtral-8x22b "$SP2" T1 288000 1 ASYM_ARENA_SHM_CAP_GB=285
cell m_sdp288 mixtral-8x22b "$SDP" T1 288000 1 ASYM_ARENA_SHM_CAP_GB=285
guard || true
echo "V2M8-DONE $(date +%m-%d_%H:%M)" >> "$S"
