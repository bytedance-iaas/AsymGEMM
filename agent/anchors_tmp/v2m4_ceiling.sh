...
echo "V2M4 begin $(date +%m-%d_%H:%M)" >> "$S"
cell m_spl304 mixtral-8x22b "$SPL" T1 304000 1 ASYM_ARENA_SHM_CAP_GB=285 ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=8192
cell m_sp2304 mixtral-8x22b "$SP2" T1 304000 1 ASYM_ARENA_SHM_CAP_GB=285
cell m_sdp304 mixtral-8x22b "$SDP" T1 304000 1 ASYM_ARENA_SHM_CAP_GB=285
guard || true
echo "V2M4-DONE $(date +%m-%d_%H:%M)" >> "$S"
