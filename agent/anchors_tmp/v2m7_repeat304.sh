...
echo "V2M7 begin $(date +%m-%d_%H:%M)" >> "$S"
cell m_sp2304r mixtral-8x22b "$SP2" T1 304000 1 ASYM_ARENA_SHM_CAP_GB=285
cell m_spl304r2 mixtral-8x22b "$SPL" T1 304000 1 ASYM_ARENA_SHM_CAP_GB=285 ASYM_EP_SEP_SLOT_KMAX=6144 ASYM_EP_SEP_SLOT_ROWS=2048
guard || true
echo "V2M7-DONE $(date +%m-%d_%H:%M)" >> "$S"
