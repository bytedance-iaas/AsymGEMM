...
echo "V4Q begin $(date +%m-%d_%H:%M)" >> "$S"
...
cell q30_spl1040 q3-30b-a3b "$SPL" T2 1040000 1 ASYM_EP_SEP_SLOT_ROWS=65536
cell q35_spl896 q3.5-35b-a3b "$SPL" T2 896000 1 ASYM_EP_SEP_SLOT_ROWS=65536
cell q122_spl336 q3.5-122b-a10b "$SPL" T1 336000 1 ASYM_ARENA_SHM_CAP_GB=400 ASYM_EP_SEP_SLOT_ROWS=8192
guard || true
echo "V4Q-DONE $(date +%m-%d_%H:%M)" >> "$S"
