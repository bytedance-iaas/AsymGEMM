...
MEMSAVE_SERIES = [
    {"key": "superoffload",     "label": "SuperOffload + Recompute",    "color": BAR_NAVY,   "edge": "none", "hatch": None},
    {"key": "superoffload_off", "label": "SuperOffload + Act. Offload", "color": BAR_TEAL,   "edge": "none", "hatch": None},
    {"key": "ours",             "label": "AsymLoRA (Ours)",             "color": BAR_ORANGE, "edge": "none", "hatch": None},
]
...
FIGURE_PARAMS = {
    ...
    "main": {
        ...
        "intra_gap": 0.0056,    # 8% of bar width, matches tp figures
    ...
    "ep_balance": {
        ...
        "side_left_in": 1.15,   # left margin (y-label + 3-digit ticks), inches
        "side_right_in": 0.18,  # right padding, inches
        "mid_extra_in": 0.55,   # (side-by-side layout only) mid-gap widening
        "axes_bottom": 0.21,
        "axes_top": 0.86,
        "name_line_in": 0.34,   # stacked layout: model-name line under the bottom caption, inches
        "dpi": 200,
    },
    "timeline": {
        "width": 12,
