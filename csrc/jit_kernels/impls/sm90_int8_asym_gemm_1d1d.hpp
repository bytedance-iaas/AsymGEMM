...
// ============================================================================
// Validated entry points (dispatched from the architecture-agnostic
// m_grouped_int8_asym_gemm_nt_* APIs in csrc/apis/gemm.hpp).
//
// INT8 inputs + FP32 per-token (A) / per-channel (B) scales, FP32 output.
// Scale tensors must arrive pre-transposed into the TMA SF layout (done in
// the dispatch layer):
