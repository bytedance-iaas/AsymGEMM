// asym_gemm/include/asym_gemm/impls/sm89_fp8_moe_gemm.cuh
// FP8 (E4M3) grouped MoE GEMM kernels for SM89+ (Ada: RTX 4090, L40, L4).
// Requires native FP8 MMA (mma.m16n8k32.e4m3) — NOT available on SM80/A100.
// Split out of sm80_moe_gemm.cuh so the SM80 header stays sm_80-compilable.
#pragma once
...
#include <asym_gemm/impls/smxx_moe_utils.cuh>    // moe_predicated_copy, moe_convert_type
#include <asym_gemm/impls/sm89_fp8_moe_params.h> // SM89MoEFP8Params, SM89MoEFP8MaskedParams
